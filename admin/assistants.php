...
">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Dodaj asistenta</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="../scripts/php/addAssistant.php">
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required minlength="7" name="adresa" id="adresa"
                               placeholder="Konatur bb, Travnik, 72270" minlength="5" maxlength="30">
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" required name="email" id="email" name="email"
                                   placeholder="alek@live.com" minlength="3" maxlength="30">
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit">Dodaj asistenta</button>
                    </div>
                </form>
...
">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="../scripts/php/ajaxAssistant.php">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="ime">Ime</label>
                    ...
                    <div class="form-group">
                        <label for="adresa">Adresa</label>
                        <input type="text" class="form-control" required minlength="7" name="adresa"
                               id="edit_adresa"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" required name="email" id="edit_email"
                                   name="email"
    ...
    <div class="row mt-0" style="height: 100vh;">
        <div class="table-responsive col-10 mx-auto" style="overflow-x:auto;margin-top: 70px;" id="tableT">
            ...
            <table class="table-striped" style="text-align: center" id="myTable">
                ...
                $sql = $conn->query("SELECT * FROM asistenti");
...
<svg class="w-6 h-6" viewBox="0 0 20 20" style="width: 25;height: 25;fill: #14274E;"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                ...
                ?>
                <script src="../scripts/js/loadAssistants.js"></script>
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        $('#myTable').DataTable(
                            {
                                language: {
                                    searchPlaceholder: "Pretraži asistente",
                                    search: "",
                                    "decimal": "",
